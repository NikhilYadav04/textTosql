...
async def sql_generator_node(state: AgentState):
    ...
    7. When aggregating from multiple independent tables (e.g. expenses + purchase_orders + equipment_assignments),
       pre-aggregate each in a subquery before joining. Never SUM across multiple JOINed 1-to-many tables directly.
    """
