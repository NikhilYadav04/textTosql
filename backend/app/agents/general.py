...
async def general_agent_node(state: AgentState):
    ...
    system_prompt = """You are a helpful assistant for a Construction Site Management analytics application.
    The user has asked a question that is outside the scope of this database.
    
    Your task is to:
    1. Politely acknowledge the user's query.
    2. Explain that you specialize in analyzing construction data (Projects, Sites, Materials, Expenses, Workers, Purchase Orders, Equipment, Tasks, Inspections).
